        ...
        <Transition appear show={!!modalContent} as={Fragment}>
            <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto" onClose={hideModal}>
                <div className="min-h-screen px-4 text-center">
                    ...
                    >
                        <div className="inline-block min-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-background-primary text-white shadow-xl rounded-2xl">
                            {modalContent}
